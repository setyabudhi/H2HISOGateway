 ...
 * @author Bharavi Gade
 * @version $Revision: 1.1 $ $Date: 2010/12/17 08:20:17CET $
 * @see ISOMsg
 * @see ISOMUX
 * @see ISOException
 ...
 *
 */
public abstract class BDIBaseChannel extends Observable 
               ...
               LogSource, ReConfigurable, BaseChannelMBean
{
     ...
     * @see ISOPackager
     */
    public BDIBaseChannel (String host, int port, ISOPackager p) {
        this();
        setHost(host, port);
        setPackager(p);
    }
     ...
     * @see ISOPackager
     */
    public BDIBaseChannel (ISOPackager p) throws IOException {
        this();
        setPackager (p);
    }
     ...
     * @see ISOPackager
     */
    public BDIBaseChannel (ISOPackager p, ServerSocket serverSocket) 
        throws IOException 
    {
        this();
        setPackager (p);
